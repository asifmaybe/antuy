...
export const mockStudentsList: StudentRecord[] = [
  { id: "STU001", name: "Ananya Das", roll: 1 },
...
export const mockAdminResults: AdminResult[] = [
  { id: "1", studentId: "STU001", studentName: "Ananya Das", subject: "English", examType: "Quiz", marks: 18, totalMarks: 20, date: "Apr 2, 2026", uploadedBy: "Emdadul Hoque", uploadedAt: "Apr 3, 2026 10:00 AM" },
  { id: "2", studentId: "STU002", studentName: "Rahim Ahmed", subject: "English", examType: "Quiz", marks: 15, totalMarks: 20, date: "Apr 2, 2026", uploadedBy: "Emdadul Hoque", uploadedAt: "Apr 3, 2026 10:00 AM" },
  { id: "3", studentId: "STU003", studentName: "Fatema Khatun", subject: "Bengali", examType: "Class Test", marks: 24, totalMarks: 30, date: "Mar 28, 2026", uploadedBy: "Emdadul Hoque", uploadedAt: "Mar 29, 2026 9:00 AM" },
  { id: "4", studentId: "STU001", studentName: "Ananya Das", subject: "Physics", examType: "Quiz", marks: 15, totalMarks: 20, date: "Mar 25, 2026", uploadedBy: "Md. Mosharrof Hosen", uploadedAt: "Mar 26, 2026 11:00 AM" },
  { id: "5", studentId: "STU004", studentName: "Sumon Mia", subject: "Mathematics", examType: "Class Test", marks: 38, totalMarks: 50, date: "Mar 20, 2026", uploadedBy: "Razaul Karim", uploadedAt: "Mar 21, 2026 10:00 AM" },
];

export const mockAuditLog: AuditLogEntry[] = [
  { id: "1", action: "Created Assignment", performedBy: "Emdadul Hoque", subject: "English", timestamp: "Apr 10, 2026 9:00 AM", details: "English Essay — Modern Poetry" },
  { id: "2", action: "Created Exam", performedBy: "Md. Mosharrof Hosen", subject: "Physics", timestamp: "Apr 14, 2026 11:00 AM", details: "Physics Quiz on Apr 28" },
  { id: "3", action: "Posted Notice", performedBy: "Md. Mosharrof Hosen", timestamp: "Apr 12, 2026 10:30 AM", details: "Mid-term Exams announcement" },
  { id: "4", action: "Uploaded Results", performedBy: "Emdadul Hoque", subject: "English", timestamp: "Apr 3, 2026 10:00 AM", details: "English Quiz results for 10 students" },
  { id: "5", action: "Marked Attendance", performedBy: "Rina Mondal", subject: "Physics", timestamp: "Apr 15, 2026 8:30 AM", details: "Online attendance for Physics class" },
];
