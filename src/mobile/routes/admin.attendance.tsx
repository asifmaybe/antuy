    ...
    <>
      <header className="px-4 pt-6 pb-4">
        ...
        <p className="text-xs text-muted-foreground mt-1">
          {lang === "bn"
            ? "শিক্ষক অনুপস্থিত থাকলে CR অনলাইনে উপস্থিতি নিতে পারবে"
            : "CR can mark attendance online when teacher is absent"}
        </p>
      </header>
          ...
          <>
            <div>
              <Input
                ...
                placeholder={
                  lang === "bn" ? "বিষয় লিখুন (যেমন Physics)" : "Enter subject (e.g. Physics)"
                }
              />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[10px] text-muted-foreground">
                        {presentCount}/{total} {lang === "bn" ? "উপস্থিত" : "present"} ·{" "}
                        {s.marked_by} · {formatDateTime(s.created_at)}
                      </p>
                    </div>
                  </div>
                );
